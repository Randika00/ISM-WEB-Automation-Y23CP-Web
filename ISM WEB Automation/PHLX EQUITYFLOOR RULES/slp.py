...
source_id = 'PHLX EQUITYFLOOR RULES'
location_id_pdf = 'General Rules'
location_id_html = 'General Equity Rules'
...
sheet_links = {
    'General': 'https://listingcenter.nasdaq.com/rulebook/nasdaq/rules',
}
