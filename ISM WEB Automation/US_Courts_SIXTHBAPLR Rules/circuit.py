...
sheet_links = {
    'Sixth Circuit Regulations for Selection of BAP Judges': 'https://www.ca6.uscourts.gov/bankruptcy-appellate-panel'
}
...
for rule_name, url in sheet_links.items():
    ...
    pdf_url = 'https://www.ca6.uscourts.gov/sites/ca6/files/documents/bap/BAPReg_0.pdf'
    print(pdf_url)
