...
sheet_links = {
    'Appellate Rules': 'https://www.ca6.uscourts.gov/bankruptcy-appellate-panel-hearing-calendar'
}
...
for rule_name, url in sheet_links.items():
    ...
    pdf_url = 'https://www.ca6.uscourts.gov/sites/ca6/files/documents/bap/calendar/BAP%20Calendar%2009-15-22.pdf'
    print(pdf_url)
