...
sheet_links = {
    'B.A.P. Appearance Form': 'https://www.ca6.uscourts.gov/bankruptcy-appellate-panel'
}
...
for rule_name, url in sheet_links.items():
    ...
    pdf_url = 'https://www.ca6.uscourts.gov/sites/ca6/files/documents/bap/bk_appearance.pdf'
    print(pdf_url)
