...
sheet_links = {
    'Motion Practice': 'https://www.ca6.uscourts.gov/bankruptcy-appellate-panel'
}
...
for rule_name, url in sheet_links.items():
    ...
    pdf_url = 'https://www.ca6.uscourts.gov/sites/ca6/files/documents/bap/Motion%20Practice%20Guidelines.pdf'
    print(pdf_url)
