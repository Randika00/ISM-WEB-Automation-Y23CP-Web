...
sheet_links = {
    'General Information Regarding BAP Appeals': 'https://www.ca6.uscourts.gov/bankruptcy-appellate-panel'
}
...
for rule_name, url in sheet_links.items():
    ...
    div_content = soup.find('div', class_='views-field views-field-title')
    li_element = div_content.findAll('li')
    pdf_url = 'https://www.ca6.uscourts.gov/sites/ca6/files/documents/bap/General%20Information%20Regarding%20BAP%20Appeals.pdf'
    print(pdf_url)
