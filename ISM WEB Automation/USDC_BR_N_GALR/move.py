...
sheet_links = {
    'Northern District of Georgia Local Bankruptcy Rules': 'https://www.ganb.uscourts.gov/local-rules-and-orders',
}
...
for category, url in sheet_links.items():
    ...
    pdf_url = 'https://www.ganb.uscourts.gov/sites/default/files/local_rules_effective_9-1-2019.pdf'
    print(pdf_url)
    pdf_response = requests.get(pdf_url)
