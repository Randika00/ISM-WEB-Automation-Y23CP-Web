...
sheet_links = {
    'District of Colorado Local Bankruptcy Rules - Local Rules': 'https://www.cob.uscourts.gov/local-rules',
}
...
def format_pdf_name(pdf_name, text_content):
    ...
    return f"{formatted_name.strip()}. {text_content}"
